...
<section class="section product-description-section">
    ...
    <!-- Gold Alloy Contact -->
    <div class="description__item__container gold__alloy__contact">
        <div class="description__banner"><img src="./views/layout/assets/images/gold-alloy-contact.png" alt=""></div>
    ...
    <div class="description__item__container linear__experience">
        <div class="description__content__wrapper">
            <h2 class="description__title">Trải nghiệm gõ mượt mà</h2>
            <p class="description__content__detail">Có hai phiên bản switch để lựa chọn, Milky Red Pro và Milky Yellow
                Pro, mỗi phiên bản sẽ mang đến cho bạn trải nghiệm gõ phím khác nhau.</p>
        </div>
        <div class="description__banner"><img src="./views/layout/assets/images/linear__typing.png" alt=""></div>
    </div>
    <!-- Lightly Pre-lubed -->
    <div class="description__item__container pre__lubed">
        <div class="description__content__wrapper">
            <h2 class="description__title">Được PRE-LUBED mượt mà</h2>
            <p class="description__content__detail">Tất cả các switches đã được lube một lớp mỏng trong nhà máy để mang
                lại cho bạn trải nghiệm tốt nhất có thể.</p>
        </div>
        <div class="description__banner"><img src="./views/layout/assets/images/lightly__pre-lubed.png" alt=""></div>
    </div>
</section>
<!-- product gallery -->
...
<section class="section customer__review__section">
    ...
    <div class="customer__reviews">
        ...
        <div class="more-products more-reviews">
            <div class="customer__review__item flex">
                <div class="customer__review__content">
                    <div class="review__content__top flex">
                        <div class="avt"><img src="./views/layout/assets/images/customer4.png" alt=""></div>
                    ...
                    <h4 class="review__content review__product__name">Milky Yellow Pro Switch Set</h4>
                    <p class="customer__review__detail">Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                        Quibusdam non
                        sequi modi labore quo omnis ad temporibus? Tenetur ipsa illo libero. Id impedit sunt sint
                        numquam dolores
                        odio fuga accusantium!</p>
                </div>
                <div class="customer__review__pictures">
                    <div class="product__gallery__wrapper">
                        <div class="gallery__item"><img
                        ...
                        <div class="gallery__item"><img
                                src="./views/layout/assets/images/gateron-ks3-milky-yellow-pro-switches-1659327297587.webp" alt="">
                        </div>
                        <div class="gallery__item"><img
                                src="/assets//images/gateron-ks3-milky-yellow-pro-switches-1659327297587.webp" alt="">
                        </div>
                    </div>
                </div>
            </div>
